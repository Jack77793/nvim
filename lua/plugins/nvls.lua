return {
	plugins = { "https://github.com/martineausimon/nvim-lilypond-suite" },
	config = function()
		require("nvls").setup({
			lilypond = {
				mappings = {
				...
				highlights = {
					...
					lilyChord = { ctermfg = "lightMagenta", fg = "lightMagenta", bold = true },
				},
			},
			latex = {
				mappings = { compile = "<F5>", open_pdf = "<F6>", lilypond_syntax = "<F3>" },
				options = { main_file = "main.tex", main_folder = "%:p:h", lilypond_syntax_au = "BufEnter" },
			},
			player = {
				mappings = {
					quit = "q",
